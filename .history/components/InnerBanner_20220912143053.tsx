...
export const InnerBanner: React.FC<{ show: boolean; onClose: () => void }> = ({ show, onClose,}) => {
    return(
        ...
        <div className={styles.mainBanner}>
            <p>
                Welcome to <span className='font-bold'>HANDYGANG</span>. An easier and 
                faster Maintance &  Services Platform
            </p>
...
const styles ={
    mainBanner:`relative rounded bg-gradient-to-r from-yellow-500 to-orange-800 py-3 px-8 text-white shadow-lg md:rounded-full`,
