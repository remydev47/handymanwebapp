  ...
  return (
    <div className="bg-neutral-900 p-4">
      <span className="block text-center text-lg text-white">
        No time to look for a Handy-man? Drop your resume Quote with{" "}
        <span className="bg-gradient-to-r from-yellow-700 via-orange-500 to-yelllow-500 bg-clip-text align-middle text-2xl font-black tracking-widest text-transparent">
          HANDY-GANG
        </span>{" "}
        headhunters here.
      </span>
