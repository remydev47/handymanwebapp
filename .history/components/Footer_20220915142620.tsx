...
const footerNav = {
  ...
  "Job Seeker": [
    ...
    { title: "Service by Location", href: "/#" },
    { title: "Sevice by Type", href: "/#" },
    { title: "Service by Experience Level", href: "/#" },
...
export const Footer = () => {
  return (
    <footer className="mt-20 bg-blue-500 dark:bg-slate-900">
      <div className="mx-auto max-w-screen-xl px-6 pt-16 sm:px-8">
        <div className="grid grid-cols-1 gap-y-6 gap-x-6 md:!grid-cols-6 md:gap-8 xs:grid-cols-2">
          <div className="mb-4  flex flex-col xs:col-span-2">
            <span className="text-xl font-bold capitalize">HandyGang</span>
            <p className="mt-4 max-w-screen-xs text-sm">
              We are on an unwavering mission to be Africa's most loved Maintance and Service
              platform, helping people discover any residential and commercial services at Low Prices.
            </p>
            <ul
